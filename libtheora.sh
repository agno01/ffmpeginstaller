...
_package='libtheora-1.1.1'
_type='tar.gz'
SURL='http://downloads.xiph.org/releases/theora'
...
echo -e "${RED} Removing old sources ${RESET}"
    ...
    cd ${_package}
    ./configure --prefix=${DDIR} --with-ogg=${DDIR} --disable-examples --disable-shared --disable-sdltest --disable-vorbistest
